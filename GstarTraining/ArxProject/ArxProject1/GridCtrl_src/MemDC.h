...
class CGridCtrlMemDC : public CDC
{
public:

    // constructor sets up the memory DC
    CGridCtrlMemDC(CDC* pDC) : CDC()
    {
        ASSERT(pDC != NULL);
    ...
    CGridCtrlMemDC* operator->() {return this;}
        
    // Allow usage as a pointer
    operator CGridCtrlMemDC*() {return this;}

private:
    CBitmap  m_bitmap;      // Offscreen bitmap
    CBitmap* m_pOldBitmap;  // bitmap originally found in CGridCtrlMemDC
