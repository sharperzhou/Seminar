...
public:
	...
	// 执行 SQL 语句 ------------------------------
	_RecordsetPtr Execute(LPCTSTR strSQL, long *lRecordsAffected, long lOptions = adCmdText);
    //BOOL CAdoConnection::Execute(LPCTSTR lpszSQL, _RecordsetPtr& RecordSet, long *lRecordsAffected, long lOptions = adCmdText);
	BOOL Cancel();
